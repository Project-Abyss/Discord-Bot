...
class template_4(discord.ui.Modal, title ='對外課程公告'):
    ...
    course_slides_note = discord.ui.TextInput(label = '簡報筆記', style = discord.TextStyle.paragraph)
